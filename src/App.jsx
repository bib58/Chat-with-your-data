      ...
      <div className="flex-1 flex flex-col relative h-full print:h-auto print:overflow-visible print:block z-10 bg-slate-950/50">
        {dataset ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center p-8 text-center relative">
            <h1 className="text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-linear-to-r from-white via-indigo-200 to-purple-300 mb-6 z-10 drop-shadow-sm">
